...
// === Zarinpal Payment Gateway (Iran) ===
tz_def('TZ_ZARINPAL', 'Zarinpal');
tz_def('TZ_ZARINPAL_TITLE', 'Iranian Payment via Zarinpal');
tz_def('TZ_ZARINPAL_DESC', 'Select your package below and pay securely through Zarinpal. Gold will be credited automatically after successful payment. Prices are in Tomans.');
tz_def('TZ_ZARINPAL_CONFIG', 'Zarinpal Configuration');
tz_def('TZ_ZARINPAL_MERCHANT_ID', 'Zarinpal Merchant ID');
tz_def('TZ_ZARINPAL_MERCHANT_ID_TOOLTIP', '36-character UUID from your zarinpal.com panel. Use your own 36-char string for sandbox testing. Leave empty to disable Zarinpal.');
tz_def('TZ_ZARINPAL_SANDBOX', 'Sandbox (Test Mode)');
tz_def('TZ_ZARINPAL_SANDBOX_TOOLTIP', 'Enable for test environment. Disable for real payments in production.');
tz_def('TZ_ZARINPAL_PACKAGE_A', 'Package A – 19,900 Tomans');
tz_def('TZ_ZARINPAL_PACKAGE_B', 'Package B – 49,900 Tomans');
tz_def('TZ_ZARINPAL_PACKAGE_C', 'Package C – 99,900 Tomans');
tz_def('TZ_ZARINPAL_PACKAGE_D', 'Package D – 199,900 Tomans');
tz_def('TZ_ZARINPAL_PACKAGE_E', 'Package E – 499,900 Tomans');
tz_def('TZ_ZARINPAL_TRANSACTIONS', 'Zarinpal Transactions');
tz_def('TZ_ZARINPAL_REF_ID', 'Ref ID');
tz_def('TZ_ZARINPAL_CARD', 'Card');
tz_def('TZ_ZARINPAL_AMOUNT', 'Amount (Toman)');
tz_def('TZ_ZARINPAL_DATE', 'Date');
tz_def('TZ_ZARINPAL_PAYMENT_SUCCESS', 'Payment successful! Gold has been credited to your account.');
tz_def('TZ_ZARINPAL_PAYMENT_FAILED', 'Payment failed or was cancelled. Please try again.');
tz_def('TZ_ZARINPAL_PAYMENT_VERIFIED', 'Payment verified. Ref ID: %s.');
tz_def('TZ_PAY_WITH_ZARINPAL', 'Pay with Zarinpal');
tz_def('ADMIN_ZARINPAL_TRANSACTIONS', 'Zarinpal Transaction Log');
tz_def('ZP_TEST_CONNECTION', '🔌 Test Connection');
tz_def('ZP_TEST_CONNECTING', '⏳ Testing...');
tz_def('ZP_TEST_SUCCESS_TITLE', '✅ Connection Successful');
tz_def('ZP_TEST_SUCCESS_DETAIL', 'Zarinpal %s API responded in %d ms. Authority: %s');
tz_def('ZP_TEST_FAILED_TITLE', '❌ Connection Failed');
tz_def('ZP_TEST_FAILED_DETAIL', '%s');
tz_def('ZP_TEST_NOT_CONFIGURED', '⚠️ Zarinpal Merchant ID is not configured. Set it in Extra Settings first.');
tz_def('ZP_TEST_HINT', 'This sends a test payment request (100 Tomans) to verify your Merchant ID and API connectivity.');
tz_def('ZP_STAT_SUCCESS', 'Successful Payments');
tz_def('ZP_STAT_GOLD_SOLD', 'Gold Sold');
tz_def('ZP_STAT_TOMANS', 'Tomans Received');
tz_def('ZP_STAT_TOTAL_TX', 'Total Transactions');
tz_def('ZP_NO_TRANSACTIONS', 'No transactions recorded yet.');
tz_def('ZP_TABLE_PLAYER', 'Player');
tz_def('ZP_TABLE_PACKAGE', 'Package');
tz_def('ZP_TABLE_STATUS', 'Status');
tz_def('CONF_PLUS_ZARINPAL', '<a href="https://www.zarinpal.com" target="_blank">Zarinpal</a> Settings');
tz_def('CONF_PLUS_ZARINPAL_TOOLTIP', 'Iranian payment gateway for automatic gold purchases. Requires merchant ID from zarinpal.com.');
tz_def('CONF_PLUS_ZP_PACKAGE_A', 'Package A Price (Rials)');
tz_def('CONF_PLUS_ZP_PACKAGE_B', 'Package B Price (Rials)');
tz_def('CONF_PLUS_ZP_PACKAGE_C', 'Package C Price (Rials)');
tz_def('CONF_PLUS_ZP_PACKAGE_D', 'Package D Price (Rials)');
tz_def('CONF_PLUS_ZP_PACKAGE_E', 'Package E Price (Rials)');
...
tz_def('ADM_QA_FORCE_CRON', '🔄 Force Run Cron');
tz_def('ADM_CRON_STATUS', 'Cron Status');
tz_def('ADM_CRON_ACTIVE', 'Active');
tz_def('ADM_CRON_INACTIVE', 'Inactive');
tz_def('ADM_CRON_NEVER', 'Never');
tz_def('ADM_CRON_AGO', 'ago');
